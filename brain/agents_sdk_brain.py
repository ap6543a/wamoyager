...
--------------------------------------
  ...
  Pseudocode (SYSTEM_PROMPT string):
    ...
    INCIDENT NOTIFICATION RULES:
      ...
      - Keep messages under 160 characters (SMS gateway limit)
    ...
    DAILY MESSAGE STYLE:
      ...
      - Keep under 160 characters (SMS gateway limit)
  ...
  Pseudocode:
    ...
    def decide_incident(self, incident, users_relevant, history_recent):
        ...
        {{
          ...
          "message_all": "the message text (max 160 chars) or null"
        }}
        """
...
--------------------------------------
  ...
  Pseudocode:
    ...
    def compose_daily_message(self, user, predictions, system_status_summary):
        ...
        - Stay under 160 characters (SMS gateway limit)
